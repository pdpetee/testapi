...
insert into department1.employee (name, salary) values ('jimmy', 123)

insert into department1.employee (name, salary) values ('kimmy', 234)

insert into department1.employee (name, salary) values ('limmy', 345)
